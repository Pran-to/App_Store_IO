...
const Navbar = () => {
    const links =[
        <NavLink className={'m-2'}  to={'/'}><li>Home</li></NavLink>,
        <NavLink className={'m-2'} to={'/Apps'}><li>Apps</li></NavLink>,
        <NavLink className={'m-2'} to={'/Installation'}><li>Installation</li></NavLink>
    ]
  return (
